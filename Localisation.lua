...
--------------------------------------------------------------------------------------------------------
-- Slash command
SLASHLOAD = " by Tiggy and Twistedfury is loaded. |c00bfffffUse '/btex menu' for configuration options.|r";
...
-- Slash command
SLASHLOAD = " par Tiggy and Twistedfury est charg\195\169. |c00bfffffUtilisez '/btex menu' pour les options de configuration.|r";
...
-- Slash command
SLASHLOAD = " von Tiggy und Twistedfury ist geladen. |c00bfffffBenutze '/btex menu' fuer die Konfigurationsoptionen.|r";
...
-- Slash command
SLASHLOAD = " by Tiggy and Twistedfury 已加载. |c00bfffff使用 '/btex menu' 进行设置.|r";
...
-- Slash command
SLASHLOAD = " by Tiggy and Twistedfury 已加載. |c00bfffff使用 '/btex menu' 進行設置.|r";
